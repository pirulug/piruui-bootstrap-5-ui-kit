(() => {
                  ...
                  for (
                    ...
                    if (!(A instanceof s)) {
                      var $,
                        S = 1;
                      if (b) {
                        if (!($ = i(F, w, e, v)) || $.index >= e.length) break;
                        var E = $.index,
                          j = $.index + $[0].length,
                          _ = w;
                        for (_ += k.value.length; E >= _; )
                          _ += (k = k.next).value.length;
                        if (((w = _ -= k.value.length), k.value instanceof s))
                          continue;
                        for (
                          var C = k;
                          C !== t.tail && (_ < j || "string" == typeof C.value);
                          C = C.next
                        )
                          (S++, (_ += C.value.length));
                        (S--, (A = e.slice(w, _)), ($.index -= w));
                      } else if (!($ = i(F, 0, A, v))) continue;
                      E = $.index;
                      var O = $[0],
                        L = A.slice(0, E),
                        P = A.slice(E + O.length),
                        z = w + A.length;
                      ...
                      if (
                        ...
                        g(t, T, S),
                        (k = u(t, T, new s(d, m ? r.tokenize(O, m) : O, y, O))),
                        P && u(t, k, P),
                        S > 1)
                      ) {
                        var M = { cause: d + "," + h, reach: z };
                        (o(e, t, n, k.prev, w, M),
              ...
              (a.hooks.add("before-highlightall", function (e) {
                ...
                a.hooks.add("before-sanity-check", function (i) {
                  ...
                  if (o.matches(s)) {
                    ...
                    (a.util.setLanguage(l, g), a.util.setLanguage(o, g));
                      ...
                      (function (e, t, n) {
                        ...
                        function (e) {
                          ...
                          if (n) {
                            var s = e.split(/\r\n?|\n/g),
                              i = n[0],
                              u = null == n[1] ? s.length : n[1];
                            (i < 0 && (i += s.length),
                              (i = Math.max(0, Math.min(i - 1, s.length))),
                              u < 0 && (u += s.length),
                              (u = Math.max(0, Math.min(u, s.length))),
                              (e = s.slice(i, u).join("\n")),
                              o.hasAttribute("data-start") ||
                                o.setAttribute("data-start", String(i + 1)));
                          }
                ...
                (a.plugins.fileHighlight = {
                  highlight: function (e) {
                    for (
                      var t, n = (e || document).querySelectorAll(s), r = 0;
                      (t = n[r++]);
                    )
  ...
  function n(a) {
    ...
    return (e[a](s, s.exports, n), (s.loaded = !0), s.exports);
  }
  ((n.g = (function () {
