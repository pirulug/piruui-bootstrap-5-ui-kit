(() => {
  ...
  class t extends HTMLElement {
    ...
    connectedCallback() {
      (this.addEventListener("pointerover", () => t.warmConnections(this), {
        once: !0,
      }),
    ...
    setupComponent() {
      (0 ===
        this.shadowRoot.querySelector("slot[name=image]").assignedNodes()
          .length && this.initImagePlaceholder(),
        this.domRefPlayButton.setAttribute(
          "aria-label",
          `${this.videoPlay}: ${this.videoTitle}`,
        ),
        this.setAttribute("title", `${this.videoPlay}: ${this.videoTitle}`),
        (this.autoLoad || this.isYouTubeShort() || this.autoPause) &&
    ...
    static warmConnections(e) {
      t.isPreconnected ||
        ...
        (t.addPrefetch("preconnect", "https://i.ytimg.com/"),
        t.addPrefetch("preconnect", "https://s.ytimg.com"),
        e.noCookie
          ? t.addPrefetch("preconnect", "https://www.youtube-nocookie.com")
          : (t.addPrefetch("preconnect", "https://www.youtube.com"),
  ...
  ((t.isPreconnected = !1), customElements.define("lite-youtube", t));
})();
